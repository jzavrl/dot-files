...
# --------------------------------------------
	export PATH="$HOME/.bin:/usr/local/bin:/usr/local/sbin:/usr/local/mysql/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/git/bin"
...
alias fov.staging='ssh -2 -p 22 root@193.2.122.59'
